...
// 72 hex-символов. Точный худший случай - полный ресинк (все 8 полей:
// 4xBAR по 77 символов "BARn:"+72hex, BRI, 3xL по OLED_LINE_BUF-1 символов,
// разделители "|") - около 521 байта, буфер увеличен до 550 с небольшим
// запасом.
